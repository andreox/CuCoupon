        ...
        <?php   
            ...
            if ( !isset($_POST["submit"]) ) {
                ...
                if ( $r1->num_rows > 0 ) {
                  ...
                  $q = "SELECT DISTINCT O.Descrizione AS O_DESCR , P.Nome AS P_NOME, P.Descrizione AS P_DESCR , O.Percentuale_sconto AS SCONTO, I.Foto AS FOTO , P1.Prezzo_originale AS ORIG, P1.Prezzo_scontato AS DISC
              ...
              else { <h1>La ricerca non ha prodotto risultati </h1> }
        ?>
