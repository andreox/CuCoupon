  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="font-weight-light">Negozio</h1>
        <p class="lead text-muted">Benvenuto <?php echo $_SESSION["username"] ; ?>, ecco le offerte che hai pubblicato.</p>
        <p>
          <a href="#" class="btn btn-primary my-2">Aggiungi Offerta</a>
          <a href="#" class="btn btn-secondary my-2">Elimina Offerta</a>
        </p>
      </div>
    </div>
  </section>
